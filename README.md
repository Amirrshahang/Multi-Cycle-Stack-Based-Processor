...
This repository contains an implementation of a **stack-based processor** with a **multi-cycle architecture** That was developed as part of the **Computer Architecture** course at **UT, S2025**.
